...
public class WorldGenReed extends WorldGenerator {
   public boolean generate(World world, Random random, int baseX, int baseY, int baseZ) {
      for(int i = 0; i < 20; ++i) {
         ...
         if (NostalgiaGenHelper.isAirBlock(world, x, baseY, z) && (NostalgiaGenHelper.getBlockMaterial(world, x - 1, baseY - 1, z) == Material.WATER || NostalgiaGenHelper.getBlockMaterial(world, x + 1, baseY - 1, z) == Material.WATER || NostalgiaGenHelper.getBlockMaterial(world, x, baseY - 1, z - 1) == Material.WATER || NostalgiaGenHelper.getBlockMaterial(world, x, baseY - 1, z + 1) == Material.WATER)) {
