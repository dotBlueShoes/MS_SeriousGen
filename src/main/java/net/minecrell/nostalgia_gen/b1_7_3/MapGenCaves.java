...
public class MapGenCaves extends MapGenBase {
   protected void func_870_a(int chunkX, int chunkZ, ChunkPrimer chunk, double var4, double var6, double var8) {
      this.func_869_a(chunkX, chunkZ, chunk, var4, var6, var8, 1.0F + this.rand.nextFloat() * 6.0F, 0.0F, 0.0F, -1, -1, 0.5);
   }

   protected void func_869_a(int chunkX, int chunkZ, ChunkPrimer chunk, double var4, double var6, double var8, float var10, float var11, float var12, int var13, int var14, double var15) {
   ...
   protected void func_868_a(World world, int x, int z, int chunkX, int chunkZ, ChunkPrimer chunk) {
      ...
      for(int var8 = 0; var8 < var7; ++var8) {
         ...
         for(int var16 = 0; var16 < var15; ++var16) {
            ...
            this.func_869_a(chunkX, chunkZ, chunk, var9, var11, var13, var19, var17, var18, 0, 0, 1.0);
         }
      }
